...
export const POST = (config)=>async (request, { params: { slug } })=>{
        const [slug1, slug2, slug3, slug4] = slug;
        let req;
        let res;
        let collection;
...
export const DELETE = (config)=>async (request, { params: { slug } })=>{
...
export const PATCH = (config)=>async (request, { params: { slug } })=>{
        const [slug1, slug2] = slug;
        let req;
        let res;
        let collection;
