export const skTranslations = {
    authentication: {
        ...
        checkYourEmailForPasswordReset: 'Skontrolujte svoj e-mail a nájdite odkaz, ktorý vám umožní bezpečne obnoviť heslo.',
        ...
        forgotPasswordEmailInstructions: 'Zadajte svoj e-mail nižšie. Dostanete e-mail s pokynmi na obnovenie hesla.',
        forgotPasswordQuestion: 'Zabudli ste heslo?',
        forgotPasswordUsernameInstructions: 'Prosím, zadajte nižšie svoje používateľské meno. Inštrukcie na obnovenie vášho hesla budú odoslané na e-mailovú adresu spojenú s vaším používateľským menom.',
        generate: 'Generovať',
        generateNewAPIKey: 'Vygenerovať nový API kľúč',
        generatingNewAPIKeyWillInvalidate: 'Vytvorenie nového API kľúča <1>zneplatní</1> predchádzajúci kľúč. Ste si istí, že chcete pokračovať?',
        ...
        loggedInChangePassword: 'Ak chcete zmeniť heslo, prejdite na svoj <0>oúčet</0> a upravte heslo tam.',
        ...
        loginWithAnotherUser: 'Ak sa chcete prihlásiť pomocou iného používateľa, najprv sa <0>odhláste</0>.',
        logout: 'Odhlásiť sa',
        logoutSuccessful: 'Odhlásenie bolo úspešné.',
        logoutUser: 'Odhlásiť používateľa',
        newAPIKeyGenerated: 'Bol vygenerovaný nový API kľúč.',
        newAccountCreated: 'Pre prístup k <a href="{{serverURL}}">{{serverURL}}</a> bol pre vás vytvorený nový účet. Kliknite na nasledujúci odkaz alebo skopírujte URL do svojho prehliadača na overenie vášho emailu: <a href="{{verificationURL}}">{{verificationURL}}</a><br> Po overení vášho emailu sa budete môcť úspešne prihlásiť.',
        ...
        youAreInactive: 'Už nejaký čas ste neaktívny a čoskoro budete z bezpečnostných dôvodov automaticky odhlásený. Chcete zostať prihlásený?',
        youAreReceivingResetPassword: 'Tento email dostanete, pretože ste (alebo niekto iný) požiadali o resetovanie hesla pre váš účet.',
        youDidNotRequestPassword: 'Ak ste o to nepožiadali, ignorujte prosím tento e-mail a vaše heslo zostane nezmenené.',
    },
    error: {
        ...
        deletingTitle: 'Pri mazaní {{title}} došlo k chybe. Skontrolujte svoje pripojenie a skúste to znova.',
    ...
    fields: {
        ...
        blockType: 'Typ bloku',
        blocks: 'bloky',
        chooseBetweenCustomTextOrDocument: 'Vyberte medzi vložením vlastného textového URL alebo odkazovaním na iný dokument.',
