...
export const LoadingOverlay = ({ animationDuration, loadingText, overlayType, show = true })=>{
...
export const LoadingOverlayToggle = ({ name: key, type = 'fullscreen', loadingText, show })=>{
...
export const FormLoadingOverlayToggle = ({ name, type = 'fullscreen', action, formIsLoading = false, loadingSuffix })=>{
