import type { BlockField, CellComponentProps, FieldTypes, SanitizedCollectionConfig, SanitizedGlobalConfig, TabsField } from 'payload';
...
export type FieldComponentProps = ArrayFieldProps | BlocksFieldProps | CheckboxFieldProps | CodeFieldProps | CollapsibleFieldProps | DateFieldProps | EmailFieldProps | GroupFieldProps | HiddenInputFieldProps | JSONFieldProps | NumberFieldProps | PointFieldProps | RelationshipFieldProps | RichTextFieldProps | RowFieldProps | SelectFieldProps | TabsFieldProps | TextFieldProps | TextareaFieldProps | UploadFieldProps;
