...
export const PreferencesProvider = ({ children })=>{
    ...
    const setPreference = useCallback(async (key, value, merge = false)=>{
        if (merge === false) {
            preferencesRef.current[key] = value;
        ...
        const updatePreference = async ()=>{
            ...
            await requests.post(`${serverURL}${api}/payload-preferences/${key}`, requestOptions(preferencesRef.current[key], i18n.language));
