...
import { $createTextNode, $getSelection, $isElementNode, $isLineBreakNode, $isNodeSelection, $isRangeSelection, $isTextNode, TextNode as TextNodeValue } from 'lexical';
...
function useAutoLink(editor, matchers, onChange) {
    useEffect(()=>{
        ...
        return mergeRegister(editor.registerNodeTransform(TextNodeValue, (textNode)=>{
