...
export function convertSlateToLexical({ converters, slateData }) {
    return {
        root: {
            type: 'root',
...
export function convertSlateNodesToLexical({ canContainParagraphs, converters, parentNodeType, slateNodes }) {
...
export function convertNodeToFormat(node) {
    let format = 0;
    if (node.bold) {
